...
IUSE="crossdev networking +regex discouraged +deprecated emacs nls debug-freelist debug-malloc debug +threads"
RESTRICT="!regex? ( test )"
...
src_configure() {
	...
	econf \
		...
		$(use_enable nls) \
		$(use_with crossdev sysroot ${SYSROOT}) \
		$(use_with !crossdev 64-calls) \
